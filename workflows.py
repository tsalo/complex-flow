...
def init_single_subject_wf(name, output_dir, layout,
    ...
    workflow.connect(bold_motionCorrection_applyMag, ('out_file', pick_first),
                     reference_wf, 'inputnode.bold_file')
    workflow.connect(inputnode, ('sbref_mag_files', pick_first),
                     reference_wf, 'inputnode.sbref_file')
    ...
    workflow.connect(inputnode, 'bold_phase_files',
                     phaseprep_wf, 'inputnode.input_phase')
    workflow.connect(inputnode, 'bold_mag_files',
                     phaseprep_wf, 'inputnode.input_mag')

    # These ones are constant across echoes
    workflow.connect(bold_motionCorrection_estimate, 'oned_matrix_save',
                     phaseprep_wf, 'inputnode.motion_par')
    workflow.connect(reference_wf, 'outputnode.bold_mask',
                     phaseprep_wf, 'inputnode.mask_file')
    ...
    workflow.connect(get_motpar_name_node, 'out_file',
                     bold_motionCorrection_estimate, 'oned_matrix_save')
    workflow.connect(inputnode, ('sbref_mag_files', pick_first),
