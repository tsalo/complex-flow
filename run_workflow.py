...
from test_docma import init_preproc_workflow


def get_parser():
    """Build parser object"""
    parser = argparse.ArgumentParser(
        description='Complex Preproc BIDS arguments',
    ...
    parser.add_argument(
        'output_dir',
        help='The directory where the output directory '
    ...
    image_opts.add_argument(
        ...
        action='store',
        default=None,
        help='select a session to analyze',
    )
    image_opts.add_argument(
        '-t',
        '--task-label',
